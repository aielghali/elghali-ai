/**
 * Elghali AI - Complete Race Database v3.0.1
 * FORCE UPDATE: 2026-02-22T12:00:00Z
 * 
 * This file contains complete race data for all UAE racecourses
 * Including: Horse numbers, withdrawals, non-runners, and surprises
 */

// Force cache bust
export const CACHE_VERSION = "3.0.1-force-update-20260222120000";
...
export const UAE_RACES: RaceDayEntry[] = [
  {
    ...
    races: [
      // RACE 1 - 16:00
      {
        number: 1, name: 'Purebred Arabian Maiden Stakes (Dirt)', time: '16:00',
        distance: 1800, surface: 'Dirt', going: 'Fast', raceType: 'Maiden', raceClass: 'Maiden', prize: 35000,
        withdrawals: [], nonRunners: [],
        horses: [
      ...
      // RACE 2 - 16:30
      {
        number: 2, name: 'Purebred Arabian Maiden Stakes (Dirt)', time: '16:30',
        distance: 1400, surface: 'Dirt', going: 'Fast', raceType: 'Maiden', raceClass: 'Maiden', prize: 35000,
        withdrawals: [], nonRunners: [],
        horses: [
      ...
      // RACE 3 - 17:00
      {
        number: 3, name: 'Rated Maiden Stakes (Dirt)', time: '17:00',
        distance: 1600, surface: 'Dirt', going: 'Fast', raceType: 'Maiden', raceClass: 'Rated', prize: 40000,
        withdrawals: [], nonRunners: [],
        horses: [
      ...
      // RACE 4 - 17:30
      {
        number: 4, name: 'Purebred Arabian Handicap (Dirt)', time: '17:30',
        distance: 1800, surface: 'Dirt', going: 'Fast', raceType: 'Handicap', raceClass: 'Handicap 0-75', prize: 45000,
        withdrawals: [], nonRunners: [],
        horses: [
      ...
      // RACE 5 - 18:00
      {
        number: 5, name: 'Purebred Arabian Fillies Maiden Stakes (Dirt)', time: '18:00',
        distance: 1400, surface: 'Dirt', going: 'Fast', raceType: 'Maiden', raceClass: 'Fillies Maiden', prize: 38000,
        withdrawals: [], nonRunners: [],
        horses: [
      ...
      // RACE 6 - 18:30
      {
        number: 6, name: 'Purebred Arabian Handicap (Dirt)', time: '18:30',
        distance: 2000, surface: 'Dirt', going: 'Fast', raceType: 'Handicap', raceClass: 'Handicap 0-80', prize: 48000,
        withdrawals: [], nonRunners: [],
        horses: [
      ...
      // RACE 7 - 19:00
      {
        number: 7, name: 'Purebred Arabian Handicap (Dirt)', time: '19:00',
        distance: 1600, surface: 'Dirt', going: 'Fast', raceType: 'Handicap', raceClass: 'Handicap 0-85', prize: 50000,
        withdrawals: [], nonRunners: [],
        horses: [
      ...
      // RACE 8 - 19:30
      {
        number: 8, name: 'Purebred Arabian Handicap (Dirt)', time: '19:30',
        distance: 1800, surface: 'Dirt', going: 'Fast', raceType: 'Handicap', raceClass: 'Handicap 0-80', prize: 48000,
        withdrawals: [], nonRunners: [],
        horses: [
      ...
      // RACE 9 - 20:00
      {
        number: 9, name: 'Purebred Arabian Stakes (Dirt)', time: '20:00',
        distance: 1600, surface: 'Dirt', going: 'Fast', raceType: 'Stakes', raceClass: 'Stakes', prize: 55000,
        withdrawals: [], nonRunners: [],
        horses: [
      ...
      // RACE 10 - 20:30 (MARATHON)
      {
        number: 10, name: 'Second Leg of the Al Ain Marathon Series (Dirt)', time: '20:30',
        distance: 3200, surface: 'Dirt', going: 'Fast', raceType: 'Stakes', raceClass: 'Marathon Series', prize: 75000,
        withdrawals: [], nonRunners: [],
        horses: [
  ...
  // MEYDAN - 2026-02-20
  {
    ...
    sources: ['Emirates Racing Authority', 'Dubai Racing Club', 'Racing Post', 'Timeform'],
    races: [
      { number: 1, name: 'DEEPAL S05 - MAIDEN (Turf)', time: '17:30', distance: 1400, surface: 'Turf', going: 'Good', raceType: 'Maiden', raceClass: 'Maiden', prize: 165000, withdrawals: [], nonRunners: [], horses: [
      ...
      { number: 2, name: 'DEEPAL S07 - HANDICAP (80-100)', time: '18:05', distance: 1400, surface: 'Dirt', going: 'Fast', raceType: 'Handicap', raceClass: 'Handicap 80-100', prize: 250000, withdrawals: [], nonRunners: [], horses: [
      ...
      { number: 3, name: 'UAE OAKS (Group 3)', time: '18:40', distance: 1900, surface: 'Dirt', going: 'Fast', raceType: 'Group', raceClass: 'Group 3', prize: 800000, withdrawals: [], nonRunners: [], horses: [
      ...
      { number: 4, name: 'Touch The Future Handicap', time: '19:15', distance: 1800, surface: 'Turf', going: 'Good', raceType: 'Handicap', raceClass: 'Handicap', prize: 300000, withdrawals: [], nonRunners: [], horses: [
      ...
      { number: 5, name: 'DEEPAL Super Hybrid Handicap', time: '19:50', distance: 2000, surface: 'Dirt', going: 'Fast', raceType: 'Handicap', raceClass: 'Handicap', prize: 300000, withdrawals: [], nonRunners: [], horses: [
      ...
      { number: 6, name: 'BALANCHINE (Group 2)', time: '20:25', distance: 1800, surface: 'Turf', going: 'Good', raceType: 'Group', raceClass: 'Group 2', prize: 850000, withdrawals: [], nonRunners: [], horses: [
      ...
      { number: 7, name: 'KENTUCKY DERBY TRIAL (Listed)', time: '21:00', distance: 1900, surface: 'Dirt', going: 'Fast', raceType: 'Stakes', raceClass: 'Listed', prize: 800000, withdrawals: [], nonRunners: [], horses: [
      ...
      { number: 8, name: 'NAD AL SHEBA TROPHY (Group 3)', time: '21:45', distance: 2800, surface: 'Turf', going: 'Good', raceType: 'Group', raceClass: 'Group 3', prize: 700000, withdrawals: [], nonRunners: [], horses: [
...
export const RACECOURSES = {
  ...
  SAUDI_ARABIA: [{ name: 'King Abdulaziz', city: 'Riyadh', surface: ['Dirt'], timezone: 'Asia/Riyadh' }],
  QATAR: [{ name: 'Al Rayyan', city: 'Doha', surface: ['Turf'], timezone: 'Asia/Qatar' }],
}
...
export function getRaceData(racecourse: string, date: string): RaceDayEntry | null {
  ...
  console.log(`[getRaceData] Looking for ${racecourse} (${normalizedRacecourse}) on ${date}`)
  console.log(`[getRaceData] Available dates: ${UAE_RACES.map(r => `${r.racecourse}=${r.date}`).join(', ')}`)
  
  const found = UAE_RACES.find(race => {
  ...
  if (found) {
    console.log(`[getRaceData] Found ${found.races.length} races for ${found.racecourse}`)
  } else {
    console.log(`[getRaceData] Not found`)
  }
...
export function normalizeRacecourse(name: string): string {
  ...
  const mapping: Record<string, string> = {
    'alain': 'Al Ain', 'meydan': 'Meydan', 'jebelali': 'Jebel Ali',
